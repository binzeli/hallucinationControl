"""
Qwen-specific implementation for running experiments with Hugging Face models.
"""
...
class QwenClient:
    """
    Runner for Qwen experiments using Hugging Face models.
    """
    ...
    def run_multi_batch_experiment(self, dataset, exp_type, reward_correct, reward_abstain, reward_incorrect, 
        ...
        all_results = []
        tracking_file = f"main_exp/popQA/outputs/qwen_batch_files/batch_tracking_{exp_type}.json"
