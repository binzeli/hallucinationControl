...
class GPTClient:
    ...
    def create_batch_input_file(self, dataset, start_idx, end_idx, exp_type, reward_correct, reward_abstain, 
        ...
        input_file = f"main_exp/TriviaQA/outputs/batch_files/batch_input_{exp_type}_{model_config['short_name']}_{start_idx}-{end_idx}.jsonl"
    ...
    def download_batch_results(self, batch, dataset, start_idx, end_idx, exp_type, reward_correct, 
        ...
        output_file = f"main_exp/TriviaQA/outputs/batch_files/batch_output_{exp_type}_{model_config['short_name']}_{start_idx}-{end_idx}_{timestamp}.jsonl"
    ...
    def run_multi_batch_experiment(self, dataset, exp_type, reward_correct, reward_abstain, reward_incorrect, 
        ...
        all_results = []
        batch_jobs = []
        tracking_file = f"main_exp/TriviaQA/outputs/batch_files/batch_tracking_{exp_type}.json"
        ...
        if all_results:
            ...
            final_file = f"main_exp/TriviaQA/outputs/{model_config['short_name']}_results/triviaqa_{exp_type}_results_{reward_str}_{timestamp}.csv"
