...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python3 main_exp/TriviaQA/run_experiment.py --model gpt-4o-mini --scheme scheme_a --samples 10 -rc 1 -ri -1
  ...
  python run_experiment.py -m gpt-5-mini -s scheme_b -rc 1 -ra 0.4 -ri -1
    ...
    print(f"\n{'='*80}")
    print(f"🚀 Starting Experiment (TriviaQA Dataset) - NON-BATCH MODE")
    print(f"{'='*80}")
